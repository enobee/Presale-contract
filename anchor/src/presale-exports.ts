...
export function getPresaleProgram(provider: AnchorProvider, address?: PublicKey) {
  return new Program({ ...PresaleIDL, address: address ? address.toBase58() : PresaleIDL.address } as Presale, provider)
}
